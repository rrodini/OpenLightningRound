...
//var playerList = [];	// array of {'name': name, 'buzzer': undefined, 'score': 0, 'registered': undefined}
var nextQuestion = 0;	// next question from questionList 
//var buzzOrder = 1;	// players buzz in sequentially
//var numberIncorrect = 0; // special counter needed to select player who buzzes after incorrect answers
//var adminForDisplay = false; // true => don't show marking buttons, questions w/ answers, etc. Admin only displays for audience.
