...
// Constructor
function MathFormatter(figures) {
...
MathFormatter.prototype.format = function format(question) {
    "use strict";
    ...
    const finalPromise = new Promise((resolve, reject) => {
        ...
        while (backtick1 >= 0 ) {
            ...
            if (question.substr(backtick1+1, 6) === "figure") {
                ...
                const figure = this.figures.get(figureRef)?this.figures.get(figureRef): FIGURE_ERROR;
