 ...
 * @param socket.id of emcee socket within new room.
 * @returns room Object (Room)
 */
Rooms.prototype.create = function (emceeId) {
    let num = genUnique(this);
    let room = new Room(num, emceeId);
    rooms.push(room);
    return room;
}
/**
...
/**
 * Destroy the given room given its number.  Assumes that the emcee has disconnected.
